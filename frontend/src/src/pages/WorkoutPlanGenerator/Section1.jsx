        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto' }}>
          ...
          {activeTab === "generate" ? (
            <div className="grid-container">
              ...
              <div>
                {loading ? (
                  <div className="empty-state-card mt-6" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '3rem', border: '1px solid rgba(34, 211, 238, 0.3)', background: 'linear-gradient(180deg, rgba(2, 6, 23, 0.8) 0%, rgba(15, 23, 42, 0.4) 100%)' }}>
                    <div style={{ marginBottom: '1.5rem', position: 'relative' }}>
                      <div style={{ position: 'absolute', inset: -10, borderRadius: '50%', background: 'linear-gradient(135deg, #22D3EE, #8B5CF6)', filter: 'blur(20px)', opacity: 0.4, animation: 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite' }} />
                      <svg className="spinner" style={{ width: '4rem', height: '4rem', color: '#22D3EE', position: 'relative', zIndex: 1 }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle style={{ opacity: 0.25 }} cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                        <path style={{ opacity: 0.75 }} fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                      </svg>
                    </div>
                    <h3 style={{ fontSize: '1.25rem', fontWeight: '800', color: 'white', marginBottom: '0.5rem', textAlign: 'center' }}>Creating Your Masterpiece...</h3>
                    <p style={{ color: '#A5B4FC', textAlign: 'center', fontSize: '0.875rem', maxWidth: '80%' }}>Your personalized workout is being generated by AI. This only takes a few seconds.</p>
                  </div>
                ) : plan ? (
